        ...
        return new LiteralEventHandler(context) {
            ...
            public void executePost(VirtualFrame frame, Object result,
                ...
                if (post != null && !skip) {
                    ...
                    Object literalType = getLiteralTypeTString();
                    if (LiteralTag.Type.FunctionLiteral.name().equals(getLiteralType()) && result instanceof JSFunctionObject) {
                        JSFunctionData functionData = JSFunction.getFunctionData((JSFunctionObject) result);
                        if (functionData.isClassConstructor()) {
                            literalType = Strings.fromJavaString(LiteralTag.Type.ClassLiteral.name());
                        }
                    }
                    cbNode.postCall(this, jalangiAnalysis, post, getSourceIID(), convertedResult, Undefined.instance, literalType);
                }
            }
